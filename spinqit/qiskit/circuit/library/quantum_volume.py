...
import numpy as np
from spinqit.qiskit.quantum_info.random import random_unitary
from spinqit.qiskit.circuit import QuantumCircuit
from spinqit.qiskit.circuit.library.generalized_gates.permutation import Permutation
...
class QuantumVolume(QuantumCircuit):
    ...
    **Reference Circuit:**
    ...
    .. jupyter-execute::
        ...
        from spinqit.qiskit.circuit.library import QuantumVolume
